...
int main(void) {
        ...
        shm_arbiter_buffer *arbiter_buffer
                = shm_arbiter_buffer_create(stream, sizeof(struct event), 100);
        ...
        for (size_t i = 0; i < 10000; ++i) {
                ...
                /* ignore all dropped events generated by stream_fetch()
                 * if there are any */
                shm_arbiter_buffer_drop(arbiter_buffer, 100);
        }
