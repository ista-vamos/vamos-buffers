...
void shm_list_embedded_insert_after(shm_list_embedded *list, shm_list_embedded *elm) {
    elm->prev = list;
    elm->next = list->next;
    list->next = elm;
    elm->next->prev = elm;
...
void shm_list_embedded_insert_list(shm_list_embedded *list, shm_list_embedded *other) {
