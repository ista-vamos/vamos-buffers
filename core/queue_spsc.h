 ...
 * shm_queue_spcs_write_offset (calls to shm_queue_spcs_write_offsets must be
 * "finished" by shm_queue_spcs_writes_finish */
...
size_t shm_queue_spsc_peek_atmost_at(shm_queue_spsc *q, size_t *k,
                                     size_t *offset);
